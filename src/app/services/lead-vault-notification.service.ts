 ...
 * a plain observable list any component can render directly. Copied
 * verbatim from web-products/network's NetworkNotificationService.
 */
@Injectable( { providedIn: 'root' } )
export class LeadVaultNotificationService {
  private nextId = 1;
