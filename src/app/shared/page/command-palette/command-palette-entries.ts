...
export const COMMAND_PALETTE_ENTRIES: CommandPaletteEntry[] = [
  // --- Lead Vault (this app) ----------------------------------------------
  { id: 'lead-vault-search', label: 'Lead Vault Search', group: 'Lead Vault', path: '/', keywords: ['search', 'leads', 'home', 'find leads', 'validate email'] },
  { id: 'lead-vault-cancel', label: 'Purchase Cancelled', group: 'Lead Vault', path: '/cancel', keywords: ['cancel', 'cancelled', 'checkout cancelled', 'purchase cancelled'] },
